export default function About() {
  return (
    ...
    >
      <div className="bg-[#2a2a2a] max-w-4xl w-full rounded-2xl p-8 shadow-lg transition-transform transform hover:scale-105 hover:shadow-2xl flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="flex-1 space-y-4 text-center md:text-left">
          ...
          <p className="text-base md:text-lg leading-relaxed">
            I'm currently in my 1B term at the University of Waterloo for Computer Engineering.
          </p>
        </div>
      </div>
    </section>
